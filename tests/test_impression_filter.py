...
def test_impression_filter_removes_impressed_articles():
    ...
    article1 = Article(article_id=uuid4(), title="Elon Musk", url="https://apnews.com/article/elon-musk-orbital-ai-data-centers-xai-spacex-92bc8ad95593bf3b5b801ddf36427194")
    article2 = Article(article_id=uuid4(), title="Iran US", url="https://apnews.com/article/iran-us-nuclear-talks-protests-araghchi-389531836ccaa4c126b5ee06c1d5b1f8")
    article3 = Article(article_id=uuid4(), title="Googles Results", url="https://apnews.com/article/google-alphabet-fourth-quarter-results-73922dd5d0c2398e1d4f23ddfccd0277")
    article4 = Article(article_id=uuid4(), title="AI OpenAI", url="https://apnews.com/article/openai-anthropic-chatgpt-claude-rivalry-c19e0cca22c37190cc4e0dc08e889ef0")
