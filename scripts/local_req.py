...
if __name__ == "__main__":
    ...
    response_topic_score = RecommendationResponseV4.model_validate(response_topic_score)

    response_feedback_score = root(req.model_dump(), pipeline="nrms_article_feedback")
    response_feedback_score = RecommendationResponseV4.model_validate(response_feedback_score)
