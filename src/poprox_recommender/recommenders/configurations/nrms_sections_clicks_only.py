...
def configure(builder: PipelineBuilder, num_slots: int, device: str):
    ...
    # Topical Sections
    topic1_deduped = builder.add_component("topic1_deduped", DuplicateFilter, candidate=n_scorer, sections=yts_sections)
    ...
    topic2_deduped = builder.add_component(
        "topic2_deduped", DuplicateFilter, candidate=n_scorer, sections=topic1_sections
    )
    ...
    topic3_deduped = builder.add_component(
        "topic3_deduped", DuplicateFilter, candidate=n_scorer, sections=topic2_sections
    )
    ...
    ion_deduped = builder.add_component("ion_deduped", DuplicateFilter, candidate=n_scorer, sections=topic3_sections)
