...
@dataclass
class NRMSMultipleUserEmbedderConfig:
    model_path: PathLike
    device: str = "cpu"
    max_clicks_per_user: int = 50


class NRMSMultipleUserEmbedder(Component):
    config: NRMSMultipleUserEmbedderConfig

    def __init__(self, config: NRMSMultipleUserEmbedderConfig | None = None, **kwargs):
